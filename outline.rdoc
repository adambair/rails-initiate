...
=== Generators
    ...
    Scaffold
      ...
      ruby script/generate scaffold Post title:string body:text
        - create all views, models, controllers, and migrations for a structure
        - the migration will have id, created_at, and updated_at automatically
      ruby script/destroy scaffold Post

    Migrations

      ruby script/generate migration some_migration_name
        - will create a blank migration for you
        - the name is merely cosmetic and for description only
      ...
      rake db:migrate   #=> run all new migrations on the development database
        - rake db:migrate RAILS_ENV=production #=> migrations on the production database
      rake db:rollback  #=> undo current migration
...
=== Console
    ...
    ruby script/console
      - this is like irb but within the context of your Rails application
